 ...
 */
@Component({
  selector: 'ng-dotlottie-worker',
  template: `
    <div [class]="className()" [style]="mergedContainerStyles()">
      <canvas #canvas class="ng-dotlottie-worker-canvas" [style]="canvasStyles"></canvas>
    </div>
  `,
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
})
export class DotLottieWorkerComponent extends ɵɵBaseDotLottieDirective {
  override readonly dotLottieCreated =
    output<import('@lottiefiles/dotlottie-web').DotLottieWorker>();
}
